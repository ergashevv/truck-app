...
function App() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_ai2c0ei', "template_sxiilyt", form.current,
      'nrD2PWIip8ZMT-_Kl')
      .then((result) => {
  ...
  return (
    <div className="App">
      <body>
          ...
          >
            <Carousel.Item>
              ...
              <Carousel.Caption style={{ bottom: "40%", zIndex: "10" }}>
                ...
                <button onClick={() => setIsModalOpen(true)} className="carousel-btn">Download</button>
              </Carousel.Caption>
            </Carousel.Item>
              ...
              <div className="inner">
                ...
                <div className="bottom">
                  ...
                  >
                    ...
                    <button><a href="https://t.me/Premiumeld_manager">Reach Our Expert Team</a></button>
                  </div>
                  <div
                    className="right"
                    data-aos="fade-up"
        ...
        <ModalAnd setOpen={setIsModalOpen} open={isModalOpen} />
          ...
          <div className="container">
            <div className="inner">
              <div className="left">
                ...
                {/* <form action="">
                  <input placeholder="Name" type="name" name="" id="" />
